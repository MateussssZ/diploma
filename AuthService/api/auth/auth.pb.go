...
type LoginResponse struct {
	...
	AccessTokenExpiry  int64                  `protobuf:"varint,3,opt,name=access_token_expiry,json=accessTokenExpiry,proto3" json:"access_token_expiry,omitempty"`
	RefreshTokenExpiry int64                  `protobuf:"varint,4,opt,name=refresh_token_expiry,json=refreshTokenExpiry,proto3" json:"refresh_token_expiry,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *LoginResponse) GetAccessTokenExpiry() int64 {
	if x != nil {
...
func (x *LoginResponse) GetRefreshTokenExpiry() int64 {
	if x != nil {
...
const file_auth_proto_rawDesc = "" +
	...
	"\x13access_token_expiry\x18\x03 \x01(\x03R\x11accessTokenExpiry\x120\n" +
	"\x14refresh_token_expiry\x18\x04 \x01(\x03R\x12refreshTokenExpiry\"4\n" +
	"\rLogoutRequest\x12#\n" +
	...
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\x12.\n" +
	"\x13access_token_expiry\x18\x03 \x01(\x03R\x11accessTokenExpiry\x120\n" +
	"\x14refresh_token_expiry\x18\x04 \x01(\x03R\x12refreshTokenExpiry2\xe7\x01\n" +
	"\vAuthService\x129\n" +
	...
	"\aRefresh\x12\x14.auth.RefreshRequest\x1a\x15.auth.RefreshResponseB\x16Z\x14authservice/api/authb\x06proto3"
